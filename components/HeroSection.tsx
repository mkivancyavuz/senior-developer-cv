  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden min-w-0 mt-12 sm:mt-14 md:mt-16">
        <FadeIn delay={0.15} y={40} className="w-full block" immediate>
          <FitHeading
            as="h1"
            text={t.hero.title}
            nowrap
      ...
      <div className="relative flex-1">
        <div
          className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 sm:top-auto sm:translate-y-0 sm:bottom-0 z-10 w-[min(340px,40vh)] sm:w-[min(430px,42vh)] md:w-[min(520px,44vh)] lg:w-[min(620px,46vh)]"
        >
